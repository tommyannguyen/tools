...
function replaceUnion(union, builder, forwardingRef, transformedTypes, debugPrintTransformations) {
    ...
    if (stringTypes.size === 0) {
        ...
        const t = Support_1.defined(collection_utils_1.iterableFirst(stringTypes));
        transformerForString = new Transformers_1.DecodingTransformer(graph, getStringType(), transformerForStringType(t));
    }
    else {
        transformerForString = new Transformers_1.DecodingTransformer(graph, getStringType(), new Transformers_1.ChoiceTransformer(graph, getStringType(), Array.from(stringTypes).map(t => Support_1.defined(transformerForStringType(t)))));
    }
