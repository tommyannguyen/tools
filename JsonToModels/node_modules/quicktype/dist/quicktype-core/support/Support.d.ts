...
export declare type StringInput = string | Readable;
export declare function toReadable(source: StringInput): Readable;
export declare function toString(source: StringInput): Promise<string>;
