...
class ConvenienceRenderer extends Renderer_1.Renderer {
    constructor(targetLanguage, renderContext) {
        ...
        this.addNameForTopLevel = (type, givenName) => {
        ...
        this.addPropertyNames = (o, className) => {
        ...
        this.addUnionMemberNames = (u, unionName) => {
        ...
        this.addEnumCaseNames = (e, enumName) => {
        ...
        this.proposedUnionMemberNameForTypeKind = (_kind) => {
            return null;
        };
        this.nameForNamedType = (t) => {
            return this.nameStoreView.get(t);
        };
        this.setAlphabetizeProperties = (value) => {
    ...
    descriptionForClassProperty(c, name) {
        const descriptions = this.typeGraph.attributeStore.tryGet(Description_1.propertyDescriptionsTypeAttributeKind, c);
        if (descriptions === undefined)
            return undefined;
    ...
    forEachTopLevel(blankLocations, f, predicate) {
        ...
        this.forEachWithBlankLines(topLevels, blankLocations, (t, name, pos) => f(t, this.nameStoreView.getForTopLevel(name), pos));
    }
    ...
    emitCommentLines(lines, lineStart, beforeLine, afterLine, firstLineStart) {
        ...
        for (const line of lines) {
            ...
            this.emitLine(start, Strings_1.trimEnd(line));
            first = false;
        }
