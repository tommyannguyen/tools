...
const TypeNames_2 = require("../TypeNames");
        ...
        for (const pe of this.path) {
            ...
            switch (pe.kind) {
                case PathElementKind.Type:
                    ...
                    break;
                case PathElementKind.KeyOrIndex:
                    acc = collection_utils_1.addHashCode(acc, stringHash(pe.key));
                    break;
                default:
                    break;
            }
        ...
        function makeObject(loc, attributes, properties, requiredArray, additionalProperties) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const props = yield collection_utils_1.mapMapSync(propertiesMap, (propSchema, propName) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const t = yield toType(checkJSONSchema(propSchema, propLoc.canonicalRef), propLoc, TypeNames_2.makeNamesTypeAttributes(pluralize.singular(propName), true));
            ...
            return __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (schema.oneOf === undefined) {
                        forEachProducedAttribute(undefined, ({ forType, forUnion, forCases }) => {
                            ...
                            if (forType !== undefined) {
                                attributes = TypeAttributes_1.combineTypeAttributes("union", attributes, forType);
                            }
                        });
                    }
                ...
                function makeObjectType() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        return yield makeObject(loc, inferredAttributes, properties, required, additionalProperties);
                    });
                }
    ...
    fetch(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (maybeInput !== undefined) {
                return checkJSONSchema(Support_1.parseJSON(yield Support_1.toString(maybeInput), "JSON Schema", address), () => Ref.root(address));
            }
...
class JSONSchemaInput {
    constructor(_schemaStore, additionalAttributeProducers = [], _additionalSchemaAddresses = []) {
        ...
        this._needIR = false;
        this._attributeProducers = [Description_1.descriptionAttributeProducer, AccessorNames_1.accessorNamesAttributeProducer].concat(additionalAttributeProducers);
    }
    get needIR() {
        return this._needIR;
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (schema === undefined) {
                ...
                for (const normalizedURI of normalizedURIs) {
                    this._schemaInputs.set(normalizedURI
                        .clone()
                        .hash("")
                        .toString(), schema);
                }
