                ...
                for (let file of files) {
                    ...
                    if (file.endsWith(".url") || file.endsWith(".json")) {
                        ...
                        graphQLSources.push({
                            ...
                            name,
                            schema: undefined,
                            query: yield NodeIO_1.readableFromFileOrURL(fileOrUrl)
                        });
                    }
                }
...
function makeInputData(sources, targetLanguage, additionalSchemaAddresses) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const source of sources) {
            switch (source.kind) {
                case "graphql":
                    ...
                    break;
                case "json":
                    yield inputData.addSource("json", source, () => quicktype_core_1.jsonInputForTargetLanguage(targetLanguage));
                    break;
                case "schema":
...
function makeQuicktypeOptions(options, targetLanguages) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (options.srcLang) {
            case "graphql":
                ...
                for (const queryFile of options.src) {
                    ...
                    const query = yield NodeIO_1.readableFromFileOrURL(queryFile);
            ...
            case "postman":
                for (const collectionFile of options.src) {
                    ...
                    for (const src of postmanSources) {
                        sources.push(Object.assign({ kind: "json" }, src));
                    }
        ...
        const inputData = yield makeInputData(sources, lang, options.additionalSchema);
...
function main(args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const resultsByFilename = yield telemetry.timeAsync("run", () => __awaiter(this, void 0, void 0, function* () { return yield quicktype_core_1.quicktypeMultiFile(quicktypeOptions); }));
